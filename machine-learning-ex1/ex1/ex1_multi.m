...
alpha = alpha / 3;
[theta2, J_history1] = gradientDescentMulti(X, y, theta, alpha, num_iters);
alpha = alpha / 3;
[theta3, J_history2] = gradientDescentMulti(X, y, theta, alpha, num_iters);
